...
SECRET_KEY = 'django-insecure-j&zz!@pki)%zo8voz5g%eikw$*==9(01xb(01+#ttc(zx6vfw%'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'lapafara_system',
        'USER': 'root',
        'PASSWORD': 'thesis123456',
...
STATIC_URL = '/static/'  # URL for accessing static files in development
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Use this if you want the static directory in the base directory of your project
]
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [('127.0.0.1', 6379)],  # Make sure your Redis server is running on this address
        },
    },
}
